    ...
    <aside class="filter-sidebar-modern">
        <form method="GET" action="<?php echo e(route('publikasi.index')); ?>">
            ...
            <?php if(request('keyword') || request('tahun') || request('urutkan')): ?>
                <a href="<?php echo e(route('publikasi.index')); ?>" class="reset-filter" style="margin-top: 15px; display: block; text-align: center; color: #008be5; text-decoration: none; font-size: 14px;">Reset Filter</a>
            <?php endif; ?>
        </form>
    </aside>
        ...
        <div class="publikasi-list">
            <?php $__empty_1 = true; $__currentLoopData = $publikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="publikasi-card">
                    ...
                    <img src="<?php echo e($sampulSrc); ?>" alt="<?php echo e($item->judul); ?>" onerror="this.src='<?php echo e(asset('images/Lambang_Badan_Pusat_Statistik_(BPS)_Indonesia.svg')); ?>';">
                    ...
                    <div class="publikasi-info">
                        ...
                        <a href="<?php echo e($item->pdf_link ?? '#'); ?>" target="_blank" rel="noopener" class="publikasi-judul-link">
