    ...
    <div class="form-card">
        ...
        <form action="<?php echo e(route('publikasi.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group-modern">
                ...
                <input type="text" id="judul" name="judul" class="form-control-modern" value="<?php echo e(old('judul')); ?>" placeholder="Masukkan judul publikasi..." required>
            </div>

            <div class="form-group-modern">
                <label for="kategori">Kategori</label>
                <input type="text" id="kategori" name="kategori" class="form-control-modern" value="<?php echo e(old('kategori')); ?>" placeholder="Contoh: Ekonomi, Sosial, Umum...">
            </div>

            <div class="form-group-modern">
                <label for="tanggal_rilis">Tanggal Rilis</label>
                <input type="date" id="tanggal_rilis" name="tanggal_rilis" class="form-control-modern" value="<?php echo e(old('tanggal_rilis')); ?>" required>
            </div>

            <div class="form-group-modern">
                <label for="abstract">Deskripsi / Abstrak</label>
                <textarea id="abstract" name="abstract" class="form-control-modern" placeholder="Tuliskan ringkasan isi publikasi..."><?php echo e(old('abstract')); ?></textarea>
            </div>
