    ...
    <div class="form-card">
        ...
        <form action="<?php echo e(route('publikasi.update', $publikasi)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group-modern">
                ...
                <input type="text" id="judul" name="judul" class="form-control-modern" value="<?php echo e(old('judul', $publikasi->judul)); ?>" required>
            </div>

            <div class="form-group-modern">
                <label for="kategori">Kategori</label>
                <input type="text" id="kategori" name="kategori" class="form-control-modern" value="<?php echo e(old('kategori', $publikasi->kategori)); ?>">
            </div>

            <div class="form-group-modern">
                <label for="tanggal_rilis">Tanggal Rilis</label>
                <input type="date" id="tanggal_rilis" name="tanggal_rilis" class="form-control-modern" value="<?php echo e(old('tanggal_rilis', $publikasi->tanggal_rilis)); ?>" required>
            </div>

            <div class="form-group-modern">
                <label for="abstract">Deskripsi / Abstrak</label>
                <textarea id="abstract" name="abstract" class="form-control-modern"><?php echo e(old('abstract', $publikasi->abstract)); ?></textarea>
            </div>
            ...
            <?php if($publikasi->sampul): ?>
                <div class="form-group-modern">
                    ...
                    <div class="current-cover-box">
                        ...
                        ?>
                        <img src="<?php echo e($sampulOldSrc); ?>" alt="Sampul Publikasi">
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('publikasi.index')); ?>" class="btn-cancel-modern">Batal</a>
            </div>
        </form>
    </div>
</div>
